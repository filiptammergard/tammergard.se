---
slug: namnsdag-api
title: Ett API för namnsdagar
description: Ett litet gratis API för att slå upp namnsdagar i Sverige, Norge, Danmark, Tyskland, Tjeckien och Polen.
authors: [filip]
tags: [javascript]
---
...
Jag har precis lagt till ett litet API på [namnsdag.tammergard.se](https://namnsdag.tammergard.se) för att slå upp namnsdagar i Sverige, Norge, Danmark, Tyskland, Tjeckien och Polen.
