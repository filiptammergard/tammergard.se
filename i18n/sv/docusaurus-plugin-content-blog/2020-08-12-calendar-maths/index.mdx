...
- Om den 53:e veckan ska finnas eller inte beror både på vilken veckodag den 1 januari nästa år är och om nuvarande år är ett [skottår](https://sv.wikipedia.org/wiki/Skott%C3%A5r) eller inte.
...
Ett år har 53 veckor precis när nästa års 1 januari hör till vecka 53. Genom att kolla i veckodagsförskjutningslistan kan man räkna hur många år i en sekvens på 28 år som har 53 veckor. Dessa år har 53 veckor:
...
Översikt av hur reglerna förhåller sig till årstidsåret (365 d 5 h 48 min 45 s). Plus = kalenderåret är längre än årstidsåret, minus = kortare.
...
Temporal landade i Chrome 144 (januari 2026) och Firefox 139 (maj 2025), och finns i Safari Technical Preview. För miljöer som inte har det än fungerar polyfillen [`@js-temporal/polyfill`](https://www.npmjs.com/package/@js-temporal/polyfill), eller ett etablerat bibliotek som [date-fns](https://date-fns.org/).
