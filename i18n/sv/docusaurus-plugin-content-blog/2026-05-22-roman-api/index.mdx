...
Bakom API:et ligger en liten sajt på [roman.tammergard.se](https://roman.tammergard.se). Där kan man konvertera mellan arabiska och romerska siffror, se dagens datum på latin, bläddra bland ettor, tiotal, hundratal och tusental, och öppna en egen sida för varje tal med grannar, dubblar och halvor.
