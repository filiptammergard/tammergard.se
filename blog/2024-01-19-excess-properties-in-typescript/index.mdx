...
description: When TypeScript flags excess properties on object literals, when it silently allows them through spread or variables, and how to tighten checks.
authors: [filip]
tags: [typescript]
---
...
The reason TypeScript is doing excess property checks when passing an "inline" object is probably since it won't be used anywhere else and [TypeScript can assume the excess property is a mistake](https://x.com/AndaristRake/status/1748250533331136947).
