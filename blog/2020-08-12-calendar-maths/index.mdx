...
- Whether the 53rd week exists depends both on what day of the week January 1 of the following year falls on, and whether the current year is a [leap year](https://en.wikipedia.org/wiki/Leap_year).
...
A year has 53 weeks precisely when the next year's January 1 belongs to week 53. By looking at the weekday-shift list, you can count how many years in a 28-year sequence have 53 weeks. These years have 53 weeks:
...
Temporal landed in Chrome 144 (January 2026) and Firefox 139 (May 2025), and is available in Safari Technical Preview. For environments that don't have it yet, the [`@js-temporal/polyfill`](https://www.npmjs.com/package/@js-temporal/polyfill) polyfill works, or an established library like [date-fns](https://date-fns.org/).
