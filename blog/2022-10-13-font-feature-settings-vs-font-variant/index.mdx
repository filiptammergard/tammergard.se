...
description: Compare the cryptic font-feature-settings property with the friendlier font-variant shorthands when enabling OpenType features like slashed zeros.
authors: [filip]
tags: [css]
---
